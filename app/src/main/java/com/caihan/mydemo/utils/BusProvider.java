package com.caihan.mydemo.utils;
...
public class BusProvider {
     ...
     * @param msg
     */
    public static void cancelEventDelivery(Object msg) {
        getInstance().cancelEventDelivery(msg);
    }
     ...
     * @param msg
     */
    public static void removeStickyEvent(Object msg) {
        getInstance().removeStickyEvent(msg);
    }
